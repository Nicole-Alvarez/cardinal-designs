...
export default function AiCreateDialog({
  ...
  async function generate() {
    ...
    try {
      setDraft(reference ? await createAiReferenceLayout(originalPrompt, canvas, reference, referenceMode, controller.current.signal) : await createAiLayout(originalPrompt, canvas));
    } catch (cause) {
      setDraft(null);
